...
if(PK.createMenuItem){
  ...
  var miniSrc = 'sets/' + encodeURIComponent(setId) + '/cards_rect/' + cardFile;
    ...
    for(var i=0;i<(items||[]).length;i++){
      ...
      img.onerror = function(){
        ...
        if(CURRENT_SET && CURRENT_COVER){
          var coverRect = 'sets/' + encodeURIComponent(CURRENT_SET) + '/cards_rect/' + CURRENT_COVER;
      ...
      if(backMode !== 'none'){
        ...
        if(backMode === 'cover'){
          backSrc = 'sets/' + encodeURIComponent(CURRENT_SET) + '/cards/' + CURRENT_COVER;
          backSrcRect = 'sets/' + encodeURIComponent(CURRENT_SET) + '/cards_rect/' + CURRENT_COVER;
