...
(function(w){
  ...
  PK.createMenuItem = function(args){
    ...
    var btn = w.document.createElement('a');
    btn.className = 'menuItem themeItem';
    btn.href = 'kaarten.html?set=' + encodeURIComponent(args.key);
    ...
    var srcRect = 'sets/' + encodeURIComponent(args.setId) + '/cards_rect/' + cardFile;
    var srcFull = 'sets/' + encodeURIComponent(args.setId) + '/cards/' + cardFile;
    var coverRect = 'sets/' + encodeURIComponent(args.setId) + '/cards_rect/' + coverFile;
    var coverFull = 'sets/' + encodeURIComponent(args.setId) + '/cards/' + coverFile;
