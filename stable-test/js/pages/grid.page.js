...
(function(w){
  ...
  function buildHeroSlide(args){
    ...
    if(!args.placeholder){
      ...
      img.className = 'bg';
      var basePath = (PK && PK.PATHS && PK.PATHS.setsDir) ? PK.PATHS.setsDir : './sets';
  ...
  function applyBackground(idx){
    ...
    var cardBase = (PK.pathForSet
      ...
      : ('./sets/' + encodeURIComponent(baseId) + '/cards_rect/'));
  ...
  function init(){
    ...
    getJson(PK.PATHS ? PK.PATHS.setsIndex : './sets/index.json').then(function(idx){
