...
(function(){
  ...
  // paden
  var BASE = '..';
  var setsDir = (window.PK && window.PK.PATHS && window.PK.PATHS.setsDir) ? window.PK.PATHS.setsDir : (BASE + '/sets');
  ...
  function requestClose(){
    ...
    window.location.href = '../kaarten.html?set=' + encodeURIComponent(setName);
  }
