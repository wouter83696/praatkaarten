...
document.addEventListener('keydown', (e) => {
  ...
  // Mobiel: uitleg sluit via swipe-down (en optioneel tap op de handler).
  const introHandle = document.getElementById('introHandle');
  if(introHandle){
    introHandle.addEventListener('click', () => {
  ...
  // Geen kruisje meer → geen fade-logica nodig bij horizontaal scrollen.
  let sheetAnim = null;
